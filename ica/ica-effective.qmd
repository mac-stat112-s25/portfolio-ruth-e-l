...
ggplot(weather, aes(y = temp3pm, x = temp9am, color = location)) + 
  geom_point() + 
  labs(x = "Temperature at 9am (Celsius)", y = "Temperature at 3pm (Celsius)", title = "Temperatures in 3 Australian Cities", color = "City")  
```
...
```{r}
#| fig-cap: "Temperature in Celsius of 3 Autralian cities at 9am and 3pm"

ggplot(weather, aes(y = temp3pm, x = temp9am, color = location)) + 
  geom_point() + 
  labs(x = "Temperature at 9am", y = "Temperature at 3pm", color = "City")  
```

```{r}
#| echo: false
#| fig-cap: "Scatterplot of Temperatures in Celsius of 3 Autralian cities at 9am and 3pm"
...
```{r}
#| fig-cap: "Density plots of 3pm temperatures in 3 Australian locations."
#| fig-alt: "A density plot of 3 pm temperatures in the Australian cities of Hobart, Uluru, and Wollongong, where Uluru experiences the most temperatures above 30 degrees Celsius, Wollongong experiences mostly temperatures around 20 degrees, and Hobart mostly around 15"
...
One should consider common types of color blindness when choosing a color palette for a visualization so that the contrasts between the colors are clear for all viewers.
...
The scale portrays global temperature as relatively stable, when the reality is that the seemingly small increase is actually a large impact for the planet. This appearance might decrease public belief in the urgency of climate change, and sway policy makers away from climate action.
